const SHOP_DATA = [
  {
    id: 1,
    title: 'Soaps',
    routeName: 'shop/soaps',
    items: [
      {
        id: 1,
        name: 'Aloe & Olive Oil',
        imageUrl: 'https://i.ibb.co/ZTXR8xB/soap11.jpg',
    ...
    items: [
      {
        ...
        description: 'Nourishing almond oil with calming Lavender',
        price: 20
      },
      {
        id: 5,
        name: 'Rose Body Oil',
        imageUrl: 'https://i.ibb.co/5MdxtxY/oils-serums.jpg',
        description: 'Jojoba oil with rose',
        price: 25
      },
      {
        id: 6,
        name: 'Calendula',
        imageUrl: 'https://i.ibb.co/5MdxtxY/oils-serums.jpg',
        description: 'Jojoba oil with calendula',
        price: 20
      }
    ]
  },
    ...
    items: [
      {
        ...
        imageUrl: 'https://i.ibb.co/28Mf8rb/belly-butter.jpg',
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        id: 11,
        name: 'Rosy Lip Tint',
        imageUrl: 'https://i.ibb.co/mGjNtrx/rosy-lip-tint.jpg',
      ...
      },
      {
        ...
        imageUrl: 'https://i.ibb.co/k38d3bp/lip-balm1.jpg',
    ...
    items: [
      {
        id: 13,
        name: 'Gift Set 1',
        imageUrl: 'https://i.ibb.co/xYZMbG0/gift-set2.jpg',
        price: 80
      }
    ]
  }
